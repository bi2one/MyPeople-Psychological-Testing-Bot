...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Result.weight_start'
        db.alter_column('wordbot_result', 'weight_start', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Result.weight_end'
        db.alter_column('wordbot_result', 'weight_end', self.gf('django.db.models.fields.IntegerField')(null=True))
        # Adding field 'Survey.result_help_description'
        db.add_column('wordbot_survey', 'result_help_description',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Result.weight_start'
        db.alter_column('wordbot_result', 'weight_start', self.gf('django.db.models.fields.IntegerField')(default=-1000))

        # Changing field 'Result.weight_end'
        db.alter_column('wordbot_result', 'weight_end', self.gf('django.db.models.fields.IntegerField')(default=1000))
        # Deleting field 'Survey.result_help_description'
        db.delete_column('wordbot_survey', 'result_help_description')
    ...
    models = {
        ...
        'wordbot.result': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'survey': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['wordbot.Survey']"}),
            'weight_end': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'weight_start': ('django.db.models.fields.IntegerField', [], {'null': 'True'})
        },
        'wordbot.resultlog': {
        ...
        'wordbot.survey': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'result_help_description': ('django.db.models.fields.TextField', [], {'null': 'True'})
        }
    }
